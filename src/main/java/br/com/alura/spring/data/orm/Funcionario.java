...
public class Funcionario {
	...
	@ManyToOne
	@JoinTable(name = "cargo_id")
	private Cargo cargo;
	
	@Fetch(FetchMode.SELECT)
	@ManyToMany(fetch = FetchType.EAGER)
	@JoinTable(name = "funcionarios_unidades", //nome da tabela de relacionamento entre as duas entidades
			joinColumns = @JoinColumn(name = "fk_funcionario_id"),	
			inverseJoinColumns = { @JoinColumn(name = "fk_unidade_id") })
